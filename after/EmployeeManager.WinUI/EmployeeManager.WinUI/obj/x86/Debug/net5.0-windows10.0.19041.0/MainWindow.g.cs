#pragma checksum "C:\Users\VBJ1BOX\Desktop\fundamentals-building-dot-net-desktop-applications\05\demos\after\EmployeeManager.WinUI\EmployeeManager.WinUI\MainWindow.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "F9EB2E1186760EB4EAF5F26A5998FC8D033CCC840E5175EAFB401BB879742DC3"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace EmployeeManager.WinUI
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
            ...
            IMainWindow_Bindings
        {
            ...
            {
                if (lineNumber == 40 && columnNumber == 11)
                {
                ...
                else if (lineNumber == 52 && columnNumber == 19)
                {
                ...
                else if (lineNumber == 65 && columnNumber == 15)
                {
            ...
            private void Update_ViewModel_SelectedEmployee(global::EmployeeManager.ViewModel.EmployeeViewModel obj, int phase)
            {
                ...
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_ViewModel_SelectedEmployee_SaveCommand(obj.SaveCommand, phase);
                    }
                }
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
            ...
            private void Update_ViewModel_SelectedEmployee_SaveCommand(global::EmployeeManager.ViewModel.Command.DelegateCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
            ...
            private void Update_ViewModel_LoadCommand(global::EmployeeManager.ViewModel.Command.DelegateCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                ...
                                bindings.Update_ViewModel_LoadCommand(obj.LoadCommand, DATA_CHANGED);
                    ...
                    if (bindings != null)
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                ...
                                bindings.Update_ViewModel_SelectedEmployee_SaveCommand(obj.SaveCommand, DATA_CHANGED);
                            }
                        }
                        else
                        {
